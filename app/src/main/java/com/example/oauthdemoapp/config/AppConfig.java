...
public class AppConfig {
    ...
    public static final Uri OAUTH_AUTH_ENDPOINT = Uri.parse("https://tu-servidor-php.com/auth/authorize");
    public static final Uri OAUTH_TOKEN_ENDPOINT = Uri.parse("https://tu-servidor-php.com/auth/token");
